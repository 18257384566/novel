            ...
            <form action="" method="post">
                ...
                <table class="add_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="mg" name="name" value="{{$role->name}}"> {{$errors->first('name')}}
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>权限描述：</th>
                        <td>
                            <input type="text" class="mg" name="display_name" value="{{$role->display_name}}"> {{$errors->first('display_name')}}
                        </td>
                    </tr>
                    <tr>
                        <th>描述：</th>
                        <td>
                            <textarea name="description">{{$role->description}}</textarea> {{$errors->first('description')}}
                        </td>
                    </tr>
                    <tr>
                        <th></th>
